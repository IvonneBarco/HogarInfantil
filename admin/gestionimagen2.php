...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "form1")) {
	...
	move_uploaded_file($_FILES['userfile']['tmp_name'], "../recursos/eveninstitucionales/".$nombre_archivo);
...
{?>
	...
	<form action="gestionimagen2.php" method="post" enctype="multipart/form-data" id="form1" name="form1">	
