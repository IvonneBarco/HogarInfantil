...
if ((isset($_GET['recordID'])) && ($_GET['recordID'] != "")) {
  ...
  echo "<center><label class='letter-r'>Noticia Eliminada</label></center><br>";
...
<html lang="es">
 ...
 <center></center><button type="button" class="btn btn-success" value="Regresar" id="regresar" onclick="location = 'lista_slidern.php'"> Regresar </button></center>
  </head>
  <body>
