...
<!--font api================================================ -->
    ...
    <title id="titulo">.:: Listar Nivel</title>
          ...
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Listar Empleados</li>
                ...
                <a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    ...
                    <h2 class="post-title">
                        <p class="titulos"><u>LISTADO DE NIVELES</u></p><br>
                    </h2>
...
<html lang="en">
  <head>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
          <p><a class="btn btn btn-warning" href="registro_nivel.php" role="button">Registrar Nivel</a></p>
        </div>
        <div class="col-md-12">
            
            <table class="titulo tscroll table table-bordered table-hover table-responsive" >
            ...
            <table class="tscroll table table-bordered table-hover table-responsive">
             
                  <?php do { ?>
                  <tr>
                    <td style="vertical-middle"><h4 class="font-csc-"><?php echo $row_ms_slider['codigo']; ?></h4></td>
                    <td style="vertical-middle"><h4 class="font-csc-"><?php echo $row_ms_slider['nombre']; ?></h4></td>
                    <td style="vertical-middle"><h4 class="font-csc-"><?php echo $row_ms_slider['descripcion']; ?></h4></td>                    
                    <td><img src="../recursos/info/<?php echo $row_ms_slider['imagen']; ?>" width="140" height="160"></td>
                    <td style="vertical-middle"><h4 class="font-csc-"><?php echo $row_ms_slider['duracion']; ?></h4></td>
                    <td><?php if ($row_ms_slider['estado'] == 1)
                                  echo "Activado";
                               else
                                  echo "Desactivado"; ?></td>
                   
                    <td><a class="btn btn btn-success btn-sm" href="editar_nivel.php?recordID=<?php echo $row_ms_slider['codigo']; ?>" role="button">Editar</a>
                      <a class="btn btn btn-danger btn-sm" href="eliminar_nivel.php?recordID=<?php echo $row_ms_slider['codigo']; ?>" role="button">Eliminar</a>                   </td>
                  </tr>
