...
<!--font api================================================ -->
  ...
  <title id="titulo">.:: Eliminar Información Institucional</title>
      ...
      <section class="posts col-md-12">       
        <div class="migas-de-pan"> <!--Inicia migas de pan-->       
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Eliminar Información</li>
          </ol>
...
<h2 class="post-title">
 <p class="titulos"><u>ELIMINAR INFORMACIÓN INSTITUCIONAL</u></p><br>
</h2>
...
if ((isset($_GET['recordID'])) && ($_GET['recordID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM info WHERE codigo=%s",
  ...
  $deleteGoTo = "lista_sliderinfo.php";
