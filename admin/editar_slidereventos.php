...
<head>
	...
	<title id="titulo">.:: Editar Proyectos Institucionales</title>
					...
					<div class="collapse navbar-collapse" id="navegacion-cs">
						<ul class="nav navbar-nav">
							...
							<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"><span class="glyphicon glyphicon-user" id="icono"></span>Institucional<span class="caret"></span></a> 
								...
								<ul class="dropdown-menu" role="menu">
									<li><a href="registro_slidereventos.php" id="">Registrar Eventos</a></li>
									<li class="divider"></li>
									<li><a href="lista_slidereventos.php" id="">Listar Información Institucional</a></li>
								</ul>
							</li>
			...
			<section class="posts col-md-12">				
				<div class="migas-de-pan"> <!--Inicia migas de pan-->				
					<ol class="breadcrumb" id="miga">
						...
						<li class="active">Editar Proyectos Institucionales</li>
					</ol>
...
<h2 class="post-title">
    <p class="titulos"><u>EDITAR PROYECTOS INSTITUCIONALES</u></p><br>
</h2>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE eveninstitucionales SET titulo=%s, descripcion=%s, imagen=%s, orden=%s, estado=%s WHERE codigo=%s",
  ...
  $updateGoTo = "lista_slidereventos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_cnx_slider, $cnx_slider);
$query_edit_slider = sprintf("SELECT * FROM eveninstitucionales WHERE eveninstitucionales.codigo = %s", $varDato_edit_slider);
...
<html lang="es">
  <head>
    ...
    <title>Editar Eventos Institucionales</title>
    <!-- Bootstrap -->
...
<div class="row">
  ...
  <div class="col-md-8">
	  ...
	  <button type="button" class="btn btn-success" value="Regresar" id="regresar" onclick="location = 'lista_slidereventos.php'"> Regresar </button>
