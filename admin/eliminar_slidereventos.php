...
<!--font api================================================ -->
  ...
  <title id="titulo">.:: Eliminar Proyectos Institucionales</title>
      ...
      <section class="posts col-md-12">       
        <div class="migas-de-pan"> <!--Inicia migas de pan-->       
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Eliminar Proyectos</li>
          </ol>
...
<h2 class="post-title">
 <p class="titulos"><u>ELIMINAR PROYECTOS INSTITUCIONALES</u></p><br>
</h2>
...
if ((isset($_GET['recordID'])) && ($_GET['recordID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM eveninstitucionales WHERE codigo=%s",
                       GetSQLValueString($_GET['recordID'], "int"));

  mysql_select_db($database_cnx_slider, $cnx_slider);
  $Result1 = mysql_query($deleteSQL, $cnx_slider) or die(mysql_error());

  echo "<center><label class='letter-r'>Información Institucional</label></center><br>";

  $deleteGoTo = "lista_slidereventos.php";
