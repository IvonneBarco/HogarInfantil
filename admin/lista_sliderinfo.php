...
<!--font api================================================ -->
    ...
    <title id="titulo">.:: Listar Información Institucional</title>
      ...
      <section class="posts col-md-12">       
        <div class="migas-de-pan"> <!--Inicia migas de pan-->       
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Información Institucional</li>
            <li class="active">Listar Información Institucional</li>
          </ol>
                ...
                <a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    ...
                    <h2 class="post-title">
                        <p class="titulos"><u>LISTADO INFORMACIÓN INSTITUCIONAL</u></p><br>
                    </h2>
...
$query_ms_slider = "SELECT * FROM info";
...
<html lang="en">
  <head>
    ...
    <title>Listar Información Institucional</title>
    <!-- Bootstrap -->
  ...
  <body>
    <div class="container">
        ...
        <div class="col-md-12">
          <p><a class="btn btn btn-warning" href="registro_sliderinfo.php" role="button">Registrar Información Institucional</a></p>
        </div>
        <div class="col-md-12">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php if ($row_ms_slider['estado'] == 1)
                                  ...
                                  echo "Desactivado"; ?></td>
                    <td><a class="btn btn btn-success btn-sm" href="editar_sliderinfo.php?recordID=<?php echo $row_ms_slider['codigo']; ?>" role="button">Editar</a>
                      <a class="btn btn btn-danger btn-sm" href="eliminar_sliderinfo.php?recordID=<?php echo $row_ms_slider['codigo']; ?>" role="button">Eliminar</a>                    </td>
                  </tr>
