...
<head>
	...
	<title id="titulo">.:: Registrar Nivel</title>
          ...
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Registrar Empleado</li>
				...
				<a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    ...
                    <h2 class="post-title">
                        <p class="titulos"><u>REGISTRAR NIVEL</u></p><br>
                    </h2>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO niveles (codigo, nombre, descripcion, imagen, duracion, estado) VALUES (%s, %s, %s, %s, %s, %s)",
...
<div class="row">
  ...
  <div class="col-md-8">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="codigo" value="" placeholder="Codigo" required>
		<div class="form-group">
       ...
       onclick="javascript:subirimagen('imagen');"/>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="duracion" value="" placeholder="Duración" required>
		</div>	
