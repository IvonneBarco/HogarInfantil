...
?>
<title id="titulo">.:: Lista Niveles</title>
		...
		<div class="row"> <!-- Inicia contenedor-->			
			...
			<section class="posts col-md-12">				
				...
				<a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
					<h2 class="post-title">
						<p class="titulos"><u>LISTADO NIVELES</u></p>
					</h2>
					<br><br>
						<div class="row">
							<div class="col-lg-12">	
					  		<?php
								...
								echo "<tr><th><center>CÓDIGO</center></th><th align='center'><center>NOMBRE</center></th><th><center>DESCRIPCIÓN</center></th><th><center>IMAGEN</center></th><th><center>DURACIÓN</center></th></tr>\n";
								while ($registro = mysqli_fetch_assoc($resultado)){
									echo "<tr><td><b>".$registro['codigo']."</b></td><td>".utf8_encode($registro['nombre'])."</td><td>".utf8_encode($registro['descripcion'])."</td><td>".utf8_encode($registro['imagen'])."</td><td>".utf8_encode($registro['duracion'])."</td></tr>\n";
