...
<head>
	...
	<title id="titulo">.:: Registrar Noticias</title>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO slider (titulo, imagen, noticia, link, orden, estado, fecha) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  <div class="col-md-8">
       ...
       onclick="javascript:subirimagen('imagen');"/>
		...
		<div class="form-group">
			...
			<input type="date" class="form-control" name="fecha" id="fecreg" required>
		</div>
