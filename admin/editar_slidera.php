      ...
      <section class="posts col-md-12">       
        <div class="migas-de-pan"> <!--Inicia migas de pan-->       
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Editar Artesano</li>
          </ol>
				...
				<a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    <h2 class="post-title">
                        <p class="titulos"><u>EDITAR ARTESANO</u></p><br>
                    </h2>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE conartesanos SET descripcion=%s, imagen=%s WHERE identificacion=%s",
...
mysql_select_db($database_cnx_slider, $cnx_slider);
$query_edit_slider = sprintf("SELECT * FROM conartesanos WHERE conartesanos.identificacion = %s", $varDato_edit_slider);
