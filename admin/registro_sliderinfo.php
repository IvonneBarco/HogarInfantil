...
<head>
	...
	<title id="titulo">.:: Información Institucional</title>
          ...
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Información Institucional</li>
				...
				<a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    ...
                    <h2 class="post-title">
                        <p class="titulos"><u>REGISTRAR INFORMACIÓN INSTITUCIONAL</u></p><br>
                    </h2>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO info (titulo, descripcion,imagen,orden, estado) VALUES (%s,%s,%s,%s,%s)",
  ...
  $insertGoTo = "lista_sliderinfo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
