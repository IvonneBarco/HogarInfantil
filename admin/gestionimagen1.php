...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "form1")) {
	...
	move_uploaded_file($_FILES['userfile']['tmp_name'], "../recursos/info/".$nombre_archivo);
...
{?>
	...
	<form action="gestionimagen1.php" method="post" enctype="multipart/form-data" id="form1" name="form1">	
