...
<head>
	...
	<title id="titulo">.:: Editar Nivel</title>
...
{
	self.name='opener';
	remote = open('gestionimagen1.php?campo='+nombrecampo, 'remote', 
			...
			<section class="posts col-md-12">				
				<div class="migas-de-pan"> <!--Inicia migas de pan-->				
					<ol class="breadcrumb" id="miga">
						...
						<li class="active">Editar Información</li>
					</ol>
...
<h2 class="post-title">
    <p class="titulos"><u>EDITAR INFORMACION INSTITUCIONAL</u></p><br>
</h2>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE niveles SET codigo=%s, nombre=%s, descripcion=%s, imagen=%s, duracion=%s, estado=%s WHERE codigo=%s",
...
mysql_select_db($database_cnx_slider, $cnx_slider);
$query_edit_slider = sprintf("SELECT * FROM niveles WHERE niveles.codigo = %s", $varDato_edit_slider);
...
<html lang="es">
  <head>
    ...
    <title>Editar Información Institucional</title>
    <!-- Bootstrap -->
...
<div class="row">
  ...
  <div class="col-md-8">
	    ...
	    <div class="form-group">
			...
			<input type="text" class="form-control" name="codigo" value="<?php echo $row_edit_slider['codigo']; ?>"  required>
		</div>
		<div class="form-group">
			<label for="titulo">Nombre</label>
			<input type="text"  class="form-control" name="nombre" value="<?php echo $row_edit_slider['nombre']; ?>"  required>
		</div>
		 <div class="form-group">
			<label for="titulo">Descripción</label>
			<textarea name="descripcion" class="form-control" id="" cols="30" rows="10" required><?php echo $row_edit_slider['descripcion']; ?></textarea>
		</div>
		<div class="form-group">
			<label for="imagen">Imágen</label>
			<input type="text" class="form-control" name="imagen" value="<?php echo $row_edit_slider['imagen']; ?>">
			<br>
			<input class="btn btn-warning" type="button" name="button" id="button" value="Subir Imagen"
       onclick="javascript:subirimagen('imagen');"/>
	    </div>
		<div class="form-group">
			<label for="orden">Duración</label>
			<input type="text" class="form-control" name="duracion" value="<?php echo $row_edit_slider['duracion']; ?>" required>
		</div>
		<div class="form-group">
      ...
      <input type="hidden" name="codigo" value="<?php echo $row_edit_slider['codigo']; ?>">
    </form>
    </div>
