...
<div class="container">
	...
	<h1 id="miGaleria">EVENTOS ESCOLARES</h1> <br><br><br><br>
	...
	<section class="main container"> <!-- Inicia Pagina Principal -->		
		<article class="post clearfix col-xs-12">
			<a href="#" class="thumb pull-left">
				<img class="img-thumbnail" src="./recursos/eveninstitucionales/<?php echo $row_ms_slider['imagen']; ?>" alt="<?php echo $row_ms_slider['titulo']; ?>" title="<?php echo $row_ms_slider['titulo']; ?>" id="imgevento" style="margin-right: 20px;">
			</a>
			<h2 class="txtev">
				<?php echo $row_ms_slider['titulo']; ?>
			</h2>					
			<p class="post-contenido text-justify" style="color: #5E5E5E;">
